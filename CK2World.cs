...
namespace CK2Helper
{
    public class CK2World
    {
        ...
        public Dictionary<string, CK2CultureGroup> CK2CultureGroups { get; private set; }
        public Bitmap ProvinceMap { get; set; }
        public string Date { get;  set; }
        public Dictionary<int, CK2Province> CK2Provinces { get; set; }
        public Dictionary<int, CK2Province> CK2ProvinceDupes { get; set; }
        ///// <summary>
        ///// maps ck2 province IDs to the county title ID
        ///// </summary>
        //public Dictionary<string, string> CK2ProvCounties { get; set; }
        ///// <summary>
        ///// same as CK2ProvCounties but for those annoying cases were PDX put 2 provinces with the same ID in the history files
        ///// </summary>
        //public Dictionary<string, string> CK2DupeProvCounties { get; set; }
